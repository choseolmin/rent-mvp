export const managerAbi = [
    { "type":"function","name":"joinLease","inputs":[{"name":"listingId","type":"uint256"}],
      "outputs":[],"stateMutability":"nonpayable" },
    { "type":"function","name":"dueNow","inputs":[{"name":"leaseId","type":"uint256"}],
      "outputs":[{"type":"bool"}],"stateMutability":"view" },
    { "type":"function","name":"payRent","inputs":[{"name":"leaseId","type":"uint256"}],
      "outputs":[],"stateMutability":"nonpayable" },
    { "type":"function","name":"leases","inputs":[{"name":"leaseId","type":"uint256"}],
      "outputs":[
    ...
    { "type":"event","name":"LeaseStarted","inputs":[
